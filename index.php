                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="processing-hero-images-wrap wow move-up">
                            <div class="processing-hero-images">
                                <img class="img-fluid" src="assets/client/people.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="faq-wrapper faq-custom-col">
                            ...
                            <div class="section-title section-space--mb_40">
                                ...
                                <h3 class="heading">Compartilhe da mesma <span class="text-color-primary"> alegria </span> que nossos clientes.</h3>
                            ...
                            <div id="accordion">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <h5 class="mb-0">
                                            <button class="btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                Planos Corporativos e Provedores<span> <i class="fas fa-chevron-down"></i>
                                    ...
                                    <div id="collapseOne" class="show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Oferecemos a sua empresa o monitoramento de 24 horas! E se isso não for suficiente para que você fique conectado temos um SLA de 4 horas. Tá esperando mais o que ? Vem ficar conectado com a gente ! </p>
                                            <button type="button" class="button-dark button-block" data-toggle="modal" data-target="#modalCorporativo">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                Meu negocio precisa de internet.<span> <i class="fas fa-chevron-down"></i>
                                                    <i class="fas fa-chevron-up"></i> </span>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Você precisa de internet no seu comercio ? Temos uma equipe pronta para te
                                                atender, basta você clicar no botão abaixo que entramos em contato com você. </p>

                                            <button type="button" class="button-dark button-block" data-toggle="modal" data-target="#modalComercial">Saiba Mais</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                Preciso de internet na minha residência <span> <i class="fas fa-chevron-down"></i>
                                                    <i class="fas fa-chevron-up"></i> </span>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>
                                                Para ter internet fibra otica na sua casa com muita velocidade e compromisso ficou fácil, basta ligar pra gente <strong> 4062-9035 </strong> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="rv-video-section">
                            ...
                            <div class="ht-banner-01 ">
                                <img class="img-fluid border-radus-5 animation_images one wow fadeInDown" width='180' src="assets/client/network01.jpg" alt="">
                            </div>

                            <div class="ht-banner-02">
                                <img class="img-fluid border-radus-5 animation_images two wow fadeInDown" width='220' src="assets/client/network02.jpg" alt="">
                            </div>

                            <div class="main-video-box video-popup">
                                <a href="https://www.youtube.com/watch?v=9No-FiEInLA" class="video-link  mt-30">
                                    <div class="single-popup-wrap">
                                        <img class="img-fluid border-radus-5" src="assets/client/fiber01.jpg" alt="">
                            ...
                            <div class="ht-banner-03">
                                <img class="img-fluid border-radus-5 animation_images three wow fadeInDown" width='120' src="assets/client/network03.jpg" alt="">
                            </div>

                            <div class="ht-banner-04">
                                <img class="img-fluid border-radus-5 animation_images four wow fadeInDown" width='130' src="assets/client/network04.jpg" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title-wrap text-center section-space--mb_10">
                            <h6 class="section-sub-title mb-20">Nossos serviços</h6>
                            <h3 class="heading">O que você pode esperar da, <br> <span class="text-color-primary"> Networks.</span></h3>
                        </div>
                        <!-- section-title-wrap Start -->
                    </div>
                </div>
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60  small-mt__40">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Mesma velocidade de Upload e Download </h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Internet 100 % Fibra Optica</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Internet segura</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Internet de Ultra velocidade</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Suporte no melhor prazo para você ! </h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    ...
                                    <a href="#" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            ...
                                            <div class="content">
                                                <h6 class="heading">Fatura digital</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-1">
                        <div class="modern-number-01 mr-5">
                            <h2 class="heading"><span class="mark-text">12</span>Anos de Experiencia</h2>
                            <h3 class="heading">Cliente satisfeito <span class="text-color-primary">a chave para nosso sucesso.</span></h3>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">5000</div>
                                    <h6 class="fun-fact__text">Clientes</h6>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">32 </div>
                                    <h6 class="fun-fact__text">Regiões atentidas</h6>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                ...
                <div class="row" id="plains_list_01">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title-wrap text-center section-space--mb_30">
                            <h6 class="section-sub-title mb-20">Principais Planos</h6>
                            <h3 class="heading">Separamos os principais <span class="text-color-primary">planos</span> para <span class="text-color-primary">você</span>. <br> Confira agora ! </h3>
                        </div>
                        <!-- section-title-wrap Start -->
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-lg-6">
                        <div class="conact-us-wrap-one">
                            <h3 class="heading text-white">Tenha uma equipe especializada a sua disposição.</h3>

                            <div class="sub-heading text-white">Atendimento de 08:00h ás 22:00h<br>Ligue e saiba um pouco mais sobre nossos planos.</div>
